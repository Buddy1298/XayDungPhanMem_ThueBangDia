...
public class ThanhToanKhiTraFrame extends JFrame implements ActionListener, MouseListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ThanhToanKhiTraFrame frame = new ThanhToanKhiTraFrame();
	...
	public ThanhToanKhiTraFrame() {
		...
		btnDong.setBounds(254, 327, 99, 30);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(object.equals(btnDong)) {
			if(JOptionPane.showConfirmDialog(this, "Xác nhận bỏ qua trả phí?","XÁC NHẬN",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION) {
				ThanhToanKhiTraFrame.this.dispose();
				quanLyChoThueFrame.setEnabled(true);
			...
			int n = JOptionPane.showConfirmDialog(this, "Xác nhận thanh toán và tiếp tục !","Thông báo",JOptionPane.YES_NO_OPTION);
